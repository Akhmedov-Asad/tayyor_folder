...
const clickContact = document.querySelector('.click');
contactBlock.addEventListener('click', function (){
    clickContact.classList.toggle('active')
})


const anons = document.querySelector('#anons');
const anonsTitles = document.querySelector('#title__anons');
anons.addEventListener('click', function(){
    anonsTitles.classList.toggle('actives');
})
